...
import pl.pawelec.shop.admin.common.utils.SlugifyUtils;
...
public class AdminProductImageService {
    @Value("${app.uploadDir}") // sciazka wzieta z applicaation.properties
    ...
    public String uploadImage(String filename, InputStream inputStream) {
        ...
        try (OutputStream outputStream = Files.newOutputStream(filePath)){// outpustream potrzebny do zapisu naszego pliku
    ...
    public Resource serveFiles(String filename) {
        ...
        return fileSystemResourceLoader.getResource(uploadDir + filename); // odczyt pliku
